...
const winstonLogger = (lokiUrl, name, level, nodeEnv) => {
    ...
    if (nodeEnv === 'development') {
        ...
        transports.push(new winston_loki_1.default(options.loki));
    }
    else {
...
const logger = winstonLogger(app_config_1.default.LOKI_URL || 'http://loki:3100', app_config_1.default.APP_NAME || 'api-gateway', app_config_1.default.LOG_LEVEL || 'info', app_config_1.default.NODE_ENV || 'development');
